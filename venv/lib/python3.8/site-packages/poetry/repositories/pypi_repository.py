...
def _default_pypi_repository_url() -> str:
    """Returns the default PyPi repository url.

    This allows the repository URL to be globally overridden through the
    REPLIT_POETRY_PYPI_REPOSITORY environment variable.
    """
    return os.environ.get("REPLIT_POETRY_PYPI_REPOSITORY", "https://pypi.org/")
...
class PyPiRepository(RemoteRepository):
    ...
    def __init__(self, url=_default_pypi_repository_url(), disable_cache=False, fallback=True):
